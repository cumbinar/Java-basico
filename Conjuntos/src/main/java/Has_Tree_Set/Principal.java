...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("El conjunto HashSet se imprime sin orden específico");
        ...
        System.out.println("El conjunto TreeSet se imprime de menor a mayor");
        ...
        System.out.println("El comjunto LinkedHashSet se imprime en el orden de entrada");
